...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_MESSAGE(WM_FLOATING_BALL_CLICKED, OnFloatingBallClicked)
...
LRESULT CMainFrame::OnFloatingBallClicked(WPARAM wParam, LPARAM lParam)
{
	// 切换快速粘贴窗口的显示/隐藏
	...
	{
		// 显示窗口 - 使用默认设置
		m_quickPaste.ShowQPasteWnd(this, false, false, TRUE);
	}
